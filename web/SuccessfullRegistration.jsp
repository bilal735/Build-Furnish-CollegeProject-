<%-- 
    Document   : SuccessfullRegistration
    Created on : 22-Dec-2022, 10:48:15 AM
    Author     : bilal
--%>
...
<%-- 
    ...
    Created on : 22-Dec-2022, 7:28:34 AM
    Author     : bilal
--%>
<!doctype html>
<html lang="en">
...
<body class="bg-back">
    <main>
        ...
        <main>
            <section class="white-features container px-5 py-5 mx-5 my-5">
                <div class="row container-fluid">
                    
                    <div>
                        <h2>Please check your mail</h2>
<!--                        <a href="index">Click here to go back to home page</a>-->
                    </div>
                </div>
            </section>
        </main>
 ...
 <footer class="black-section footerHome successfull" id="footer">
